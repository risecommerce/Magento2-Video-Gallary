...
namespace Risecommerce\VideoGallery\Block;
...
class VideoBlock extends Template implements BlockInterface
{
    ...
    /**
     * @var \Risecommerce\VideoGallery\Helper\Data
     */
    protected $_helper;
     ...
     * @param \Risecommerce\VideoGallery\Model\VideoFactory $videoFactory
     * @param \Magento\Store\Model\StoreManagerInterface $storeManager
     * @param \Magento\Framework\App\Response\RedirectInterface $redirect
     * @param \Magento\Framework\App\Response\Http $httpResponse
     * @param \Magento\Framework\App\RequestInterface $request
     * @param \Risecommerce\VideoGallery\Helper\Data $helper
     * @param array $data
     */
    public function __construct(
        \Magento\Customer\Model\Session $session,
        Context $context,
        \Risecommerce\VideoGallery\Model\VideoFactory $videoFactory,
        \Magento\Store\Model\StoreManagerInterface $storeManager,
        \Magento\Framework\App\Response\RedirectInterface $redirect,
        \Magento\Framework\App\Response\Http $httpResponse,
        \Magento\Framework\App\RequestInterface $request,
        \Risecommerce\VideoGallery\Helper\Data $helper,
        array $data = []
    ) {
    ...
    public function getMediaUrl()
    {
        return $this->storeManager
            ->getStore()
            ->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA).'risecommerce/video_gallery/';
    }
