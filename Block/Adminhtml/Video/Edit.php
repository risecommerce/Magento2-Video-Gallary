...
namespace Risecommerce\VideoGallery\Block\Adminhtml\Video;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'id';
        $this->_blockGroup = 'Risecommerce_VideoGallery';
        $this->_controller = 'adminhtml_video';

        parent::_construct();

        if ($this->_isAllowedAction('Risecommerce_VideoGallery::save')) {
        ...
        if ($this->_isAllowedAction('Risecommerce_VideoGallery::video_delete')) {
